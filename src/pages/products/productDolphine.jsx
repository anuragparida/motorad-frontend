        ...
        <>
                ...
                (deviceType == 'Desktop') ?
                    <section class="product_vdo_sec">
                      ...
                      />
                                                ...
                                                {images.map((image) => (
                                                    <div className={classnames("image imageRotate", `image_dolphin_${image}`, {
                                                        image_visible: visibleImagesMap[image]
                                                    })}
                                                        key={image}
                                                        id={"image_dolphin_" + image}
                        ...
                        <div class="col-lg-11">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-6">
                                    ...
                                    >
                                        <img
                                            src="images/Showcase/Japan/Dolphin/Dolphine01.jpg"
                                            alt="a"
                                            class="img-fluid"
                                        />
                                    </div>
                                ...
                                <div class="col-lg-4 col-12">
                                    ...
                                    >
                                        <img
                                            src="images/Showcase/Japan/Dolphin/Dolphine_01.jpg"
                                            alt="a"
                                            class="img-fluid"
                                        />
                                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="product_spe_slider">
                                <div
                                    ...
                                    data-aos-duration="2000"
                                >
                                    <img src="images/Japan/DOLPHIN/BottomPart-BlinkingPoints/Dolphin-Pulse-part.png" alt="a" class="img-fluid" />
            ...
            <div class="book_ride_sticky d-lg-none">
                <div class="d-flex">
                    ...
                    <a href="javascript:void(0)" onClick={addToCart}><p>YEN {productPrice.dolphin.toLocaleString()}</p> BUY NOW</a>
                </div>
